        ...
        <section class="sobre">
                <div class="text">
                    ...
                    <div>
                        ...
                        <p><strong>Missão:</strong>Missão: Proporcionar uma seleção cuidadosamente curada de cosméticos e roupas femininas que inspirem confiança e expressão individual, com excelência em qualidade e serviço ao cliente.</p>
                        <p><strong>Valores:</strong> Excelência, Integridade, Empoderamento.</p>
                    </div>
                </div>
                
                <div id="div-sobre">
                    <img src="../image/sobre.jpg" alt="imagem-pagina-sobre">
